export { default as useAxiosGetContents } from "@/hooks/useAxiosGetContents";
export { default as useAxiosGetSkillDesc } from "@/hooks/useAxiosGetSkillDesc";
export { default as useCurrViewContentNum } from "@/hooks/useCurrViewContNum";
