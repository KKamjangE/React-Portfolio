...
export default function HoverMotion({
  ...
  return (
    <div
      className={clsx(
        "bg-gradient-to-r from-transparent from-50% to-accent to-50% bg-[position:0%_0%] bg-[length:200%_100%] transition-all duration-200 ease-in-out hover:bg-[position:-100%_0%]",
        {
